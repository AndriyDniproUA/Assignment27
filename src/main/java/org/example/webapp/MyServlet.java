...
public class MyServlet extends JsonServlet {
    ...
    private UserService userService = UberFactory.instance().getUserService();
    ...
    Map<String, User> users = new HashMap<>() {{
        put("1", new User().setName("Vasia1").setRole("admin"));
        put("2", new User().setName("Petia1").setRole("user"));
    }};
